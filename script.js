...
preloadNikFrame.src = "images/Pearl Grace 14.png?v=10";
...
/* COUNTDOWN */
const weddingDate = new Date("November 1, 2026 12:00:00").getTime();
...
function downloadICS() {
  const eventTitle = "Majlis Perkahwinan Ain Amira & Alif Zikrie";
  const eventLocation = "Elegant Glam Hall, Lot 1257A, Batu 1, Jalan Mentakab, 28000 Temerloh Pahang";
  const eventDescription = "Jemputan ke Majlis Perkahwinan Ain Amira & Alif Zikrie.";

  const startTime = "20261101T120000";
  const endTime = "20261101T160000";

  const icsContent = `BEGIN:VCALENDAR
VERSION:2.0
PRODID:-//NikahLink//Wedding Invitation//MS
BEGIN:VEVENT
UID:ainamira-alifzikrie-20261101@nikahlink
...
END:VCALENDAR`;
  ...
  link.download = "majlis-ainamira-alifzikrie.ics";
...
function submitRSVP(event) {
  ...
  // Nombor WhatsApp baru untuk terima mesej RSVP
  const whatsappNumber = "60197823382";
